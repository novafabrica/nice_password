...
* <tt>:dictionary</tt> - for a custom dictionary you would like to use instead of the default

 NicePassword.new(:language => 'fr', :word_count => 3, :digit_count => 3, :length => 16)  => été86gris61rue
